...
![Tests](https://img.shields.io/badge/tests-3%2C179%20assertions-brightgreen)
...
3. **Tests alongside features** — test cases were planned with each stage, not bolted on after. The test suites (3,179 assertions across 6 suites) were written to validate each feature as it was delivered
